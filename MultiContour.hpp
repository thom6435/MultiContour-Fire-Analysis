...
#define MAX_AVG_SET       3 // addWeighted method calls in MultiContour hard coded to handle 3 images averaging
#define PATH_SIZE       256
#define ABNORMAL_RAY_THRESHOLD 75  // Progression Vector min length threshold to be considered abnormal
#define FIRELINE_MIN_THRESHOLD 200 // Threshold for detecting fire contour in triple red imagery
#define FIRELINE_MAX_THRESHOLD 255 // Fire line detection maximum threshold (image max pixel value)
