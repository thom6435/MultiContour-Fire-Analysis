...
#define MINCOORDS  250   // threshold for critical number of points in a fire contour
#define MINAREA   8000.0 // Critical size threshold for area in a contour region segment of a fireline
